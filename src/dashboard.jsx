...
function buildLast12Months(baseDate) {
...
export default function App() {
  ...
  const scaleList = (list) => list.map((d) => ({ ...d, value: Math.round(d.value * ratio) }));
                          ...
                          <LineChart data={trenDitampilkan} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            ...
                            <Tooltip
                              ...
                              labelFormatter={(label, payload) =>
                                payload && payload[0]
                                  ? `${payload[0].payload.bulanPanjang} ${payload[0].payload.tahun}`
                                  : label
                              }
